...
values(1001, 'tadam', 'Finish the project', sysdate(), true);
insert into todo(id, username, description, target_date, is_done)
values(1002, 'tadam', 'Make the presentation', sysdate(), true);
...
insert into todo(id, username, description, target_date, is_done)
values(1005, 'ppal', 'Take the dog for a walk', sysdate(), false);
